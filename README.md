...
5. Abra os gráficos (.png) ou o arquivo `index.html` (se presente) para visualizar os resultados.  
...
- Permitir configuração externa das funções de pertinência e base de regras (ex: via arquivo).  
